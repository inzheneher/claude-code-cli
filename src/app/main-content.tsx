            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="inline-flex items-center rounded-lg bg-white/60 border border-neutral-200/60 p-0.5 h-9 shadow-sm" role="tablist">
                    <button
                      role="tab"
                      aria-selected={activeView === "preview"}
                      onClick={() => setActiveView("preview")}
                      className={`inline-flex items-center px-4 py-1.5 text-sm font-medium transition-all rounded-md ${
                        activeView === "preview"
